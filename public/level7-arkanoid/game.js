...
let H=820,PY=752;
const mapPoints={nardo_0:[.32,.40],nardo_1:[.39,.46],nardo_2:[.52,.41],nardo_3:[.58,.35],nardo_4:[.70,.36],nardo_5:[.60,.47],nardo_6:[.38,.59],nardo_7:[.45,.54],nardo_8:[.47,.64],nardo_9:[.60,.66]};
const ids=['nardo_0','nardo_1','nardo_2','nardo_3','nardo_4','nardo_5','nardo_6','nardo_7','nardo_8','nardo_9'];
const ui={
fr:{subtitle:'NIVEAU 7 · LE VOL DES OLIVES',speaker:'Tarantula',ask:'Où trouver',title:'Vise la bonne découverte.',intro:'La tarentule pose une énigme. Fais rebondir Aracne vers le lieu qui répond à sa question.',help:'Glisse le doigt pour déplacer la plateforme. Ses bords orientent le rebond. Touche le terrain pour lancer.',play:'Jouer',launch:'Envol ↗',hint:'Indice',pace:'Rythme',speeds:['Doux','Vif','Rapide'],tip:'Glisse pour diriger · touche pour lancer · espace / ← →',ready:'À toi ! Déplace la plateforme puis lance Aracne.',wrong:'Pas ce lieu. Cherche encore !',found:'Découverte !',retry:'Aracne revient. Relance depuis la plateforme !',pause:'Le vol est en pause',resume:'Reprendre',restart:'Recommencer',win:'Les 10 lieux de Nardò retrouvés !',won:'Le Sceau de Nardò rejoint ta collection dans ce navigateur.',score:'points',hintText:'Vise',loading:'Chargement…',error:'Les images ne se sont pas chargées. Réessaie.',reload:'Réessayer',again:'Rejouer',tag:'LE VOL D’ARACNE',paused:'Prends ton temps. La question et ta progression restent là.',bricks:'🫒 +5',collection:'Sceau de Nardò',recall:'Retour d’Aracne',recallTip:'Rappelle Aracne sur la plateforme pour viser à nouveau.'},
en:{subtitle:'LEVEL 7 · FLIGHT OF THE OLIVES',speaker:'Tarantula',ask:'Where can you find',title:'Aim for the right discovery.',intro:'The tarantula gives a clue. Bounce Aracne towards the place that answers her question.',help:'Slide to move the paddle. Its edges change your rebound angle. Tap the field to launch.',play:'Play',launch:'Launch ↗',hint:'Hint',pace:'Pace',speeds:['Gentle','Lively','Fast'],tip:'Slide to steer · tap to launch · space / ← →',ready:'Your turn! Move the paddle, then launch Aracne.',wrong:'Not that place. Try another!',found:'Discovered!',retry:'Aracne is back. Launch again from the paddle!',pause:'Flight paused',resume:'Resume',restart:'Restart',win:'All 10 Nardò places discovered!',won:'The Nardò Seal joins your collection in this browser.',score:'points',hintText:'Aim for',loading:'Loading…',error:'The images could not load. Please retry.',reload:'Retry',again:'Play again',tag:'ARACNE’S FLIGHT',paused:'Take your time. Your clue and progress are waiting.',bricks:'🫒 +5',collection:'Nardò Seal',recall:'Recall Aracne',recallTip:'Bring Aracne back to the paddle to aim again.'},
it:{subtitle:'LIVELLO 7 · IL VOLO DELLE OLIVE',speaker:'Tarantula',ask:'Dove si trova',title:'Mira alla scoperta giusta.',intro:'La tarantola propone un enigma. Fai rimbalzare Aracne verso il luogo che risponde alla domanda.',help:'Scorri per muovere la piattaforma. I bordi cambiano la direzione del rimbalzo. Tocca il campo per partire.',play:'Gioca',launch:'Vola ↗',hint:'Indizio',pace:'Ritmo',speeds:['Dolce','Vivace','Veloce'],tip:'Scorri per dirigere · tocca per partire · spazio / ← →',ready:'Muovi la piattaforma e fai volare Aracne!',wrong:'Non è questo luogo. Riprova!',found:'Scoperto!',retry:'Aracne è tornata. Riparti dalla piattaforma!',pause:'Il volo è in pausa',resume:'Riprendi',restart:'Ricomincia',win:'Tutti i 10 luoghi di Nardò scoperti!',won:'Il Sigillo di Nardò entra nella tua collezione in questo browser.',score:'punti',hintText:'Mira a',loading:'Caricamento…',error:'Immagini non caricate. Riprova.',reload:'Riprova',again:'Rigioca',tag:'IL VOLO DI ARACNE',paused:'Prenditi il tuo tempo. La domanda e i progressi ti aspettano.',bricks:'🫒 +5',collection:'Sigillo di Nardò',recall:'Richiama Aracne',recallTip:'Riporta Aracne sulla piattaforma per mirare di nuovo.'},
es:{subtitle:'NIVEL 7 · EL VUELO DE LAS ACEITUNAS',speaker:'Tarantula',ask:'¿Dónde está',title:'Apunta al descubrimiento correcto.',intro:'La tarántula propone un enigma. Haz rebotar a Aracne hacia el lugar que responde a su pregunta.',help:'Desliza para mover la plataforma. Sus bordes cambian el ángulo del rebote. Toca el campo para despegar.',play:'Jugar',launch:'Vuela ↗',hint:'Pista',pace:'Ritmo',speeds:['Suave','Ágil','Rápido'],tip:'Desliza para dirigir · toca para lanzar · espacio / ← →',ready:'Mueve la plataforma y lanza a Aracne.',wrong:'No es ese lugar. ¡Prueba otro!',found:'¡Descubierto!',retry:'Aracne ha vuelto. ¡Lánzala de nuevo!',pause:'Vuelo en pausa',resume:'Continuar',restart:'Reiniciar',win:'¡Los 10 lugares de Nardò descubiertos!',won:'El Sello de Nardò se añade a tu colección en este navegador.',score:'puntos',hintText:'Apunta a',loading:'Cargando…',error:'No se cargaron las imágenes. Inténtalo de nuevo.',reload:'Reintentar',again:'Volver a jugar',tag:'EL VUELO DE ARACNE',paused:'Tómate tu tiempo. Tu pregunta y progreso te esperan.',bricks:'🫒 +5',collection:'Sello de Nardò',recall:'Llamar a Aracne',recallTip:'Devuelve a Aracne a la plataforma para apuntar otra vez.'}
};
...
function wallY(row){return row===2?H*.455:H*.575+row*31}
function makeWalls(){state.bricks=Array.from({length:24},(_,i)=>{const row=Math.floor(i/8),offset=row===2?37.5:0;return{x:(i%8)*75+offset,y:wallY(row),w:75,h:30,alive:true}}).filter(b=>b.x<W);}
...
function finish(){state.mode='won';sendHost('victory',{score:state.score,leaves:state.found.length,elapsed:state.elapsed,misses:state.misses,food:{...state.food}});state.message=0;$('message').classList.remove('visible');try{if(!trainingBattle)localStorage.setItem('hirundu_l7_seal','nardo');if(!trainingBattle)localStorage.setItem('hirundu_arcade_l7_best',String(Math.max(state.score,Number(localStorage.getItem('hirundu_arcade_l7_best'))||0)))}catch{}showWin()}
...
async function loadAssets(){try{await Promise.all(['map','bird','tarantula','battle','boss','coffee','rustico','pasticciotto','crow','jelly'].map(name=>new Promise((resolve,reject)=>{const img=new Image();images[name]=img;img.onload=resolve;img.onerror=reject;img.src={"bird": "../assets/aracne%20.PNG", "map": "../assets/salento-map.PNG", "tarantula": "../assets/tarantula%20.PNG", "coffee": "../assets/caffeleccese%20.PNG", "rustico": "../assets/rustico.PNG", "pasticciotto": "../assets/bonus-pasticciotto.PNG", "boss": "../assets/boss-8.svg", "battle": "../assets/battle_bg_nardo.webp", "crow": "../assets/crow.PNG", "jelly": "../assets/jellyfish.PNG"}[name]})));state.assetsReady=true;$('play').disabled=false;if(trainingBattle){state.found=ids.slice();state.food={coffee:1,rustico:1,pasticciotto:1};hud();battleIntro()}else showIntro()}catch{$('cardText').textContent=text().error;$('play').textContent=text().reload;$('play').disabled=false;$('play').onclick=()=>location.reload()}}

const extras={
fr:{intro:'Traverse les murs de pierre pour atteindre les dix lieux des chemins de Nardò. La tarentule te donne l’indice : guide Aracne vers le bon repère numéroté.',wall:'Murs de pierre',coffee:'Caffè leccese · énergie +30',rustico:'Rustico · bouclier 8 s',pasticciotto:'Pasticciotto · énergie +20 · vol ralenti 7 s',hit:'Attention aux ennemis !',energy:'Énergie',battle:'Bataille de Nardò',battleIntro:'Les dix lieux sont retrouvés. Affronte Macina avec les provisions récoltées.',battleHelp:'← → bouger · ↑ battre des ailes · ↓ plonger · ↯ esquiver · A attaquer · B spécial.',fight:'Combattre',jump:'Battement',attack:'Attaque',special:'Spécial',warning:'Attention : Macina prépare une charge !',exposed:'Maintenant ! Macina est vulnérable.',phase:'Macina accélère !',lost:'Aracne reprend son souffle',retry:'Réessayer la bataille',lostText:'Tes découvertes et tes provisions sont conservées pour réessayer.',victory:'Les chemins de Nardò sont libres !',boss:'Macina',safe:'Bouclier actif',focus:'Vol ralenti',normal:'Vol calme',orientation:'Bataille : passe en paysage pour avoir plus de place.',victoryText:'Macina est vaincu ! Le Sceau de Nardò est conservé dans ce navigateur.'},
en:{intro:'Break through the stone walls to reach the ten places on the paths of Nardò. Follow the tarantula’s clue and guide Aracne into the right numbered marker.',wall:'Stone walls',coffee:'Caffè leccese · energy +30',rustico:'Rustico · shield 8 s',pasticciotto:'Pasticciotto · energy +20 · slower flight 7 s',hit:'Watch out for enemies!',energy:'Energy',battle:'Battle of Nardò',battleIntro:'All ten places found. Face Macina with the provisions you collected.',battleHelp:'← → move · ↑ flap · ↓ dive · ↯ dodge · A attack · B special.',fight:'Fight',jump:'Flap',attack:'Attack',special:'Special',warning:'Watch out: Macina is charging!',exposed:'Now! Macina is vulnerable.',phase:'Macina speeds up!',lost:'Aracne catches her breath',retry:'Retry battle',lostText:'Your discoveries and provisions are kept for the retry.',victory:'The paths of Nardò are free!',boss:'Macina',safe:'Shield active',focus:'Slow flight',normal:'Easy flight',orientation:'Battle: turn to landscape for more space.',victoryText:'Macina is defeated! The Nardò Seal is saved in this browser.'},
it:{intro:'Supera i muri di pietra per raggiungere i dieci luoghi dei sentieri di Nardò. Segui l’indizio della tarantola e guida Aracne sul segnaposto giusto.',wall:'Muri di pietra',coffee:'Caffè leccese · energia +30',rustico:'Rustico · scudo 8 s',pasticciotto:'Pasticciotto · energia +20 · volo lento 7 s',hit:'Attenzione ai nemici!',energy:'Energia',battle:'Battaglia di Nardò',battleIntro:'Hai trovato i dieci luoghi. Affronta Macina con le provviste raccolte.',battleHelp:'← → muovi · ↑ batti le ali · ↓ picchiata · ↯ schivata · A attacco · B speciale.',fight:'Combatti',jump:'Battito',attack:'Attacco',special:'Speciale',warning:'Attenzione: Macina sta caricando!',exposed:'Ora! Macina è vulnerabile.',phase:'Macina accelera!',lost:'Aracne riprende fiato',retry:'Riprova la battaglia',lostText:'Le scoperte e le provviste restano disponibili per riprovare.',victory:'I sentieri di Nardò sono liberi!',boss:'Macina',safe:'Scudo attivo',focus:'Volo lento',normal:'Volo tranquillo',orientation:'Battaglia: ruota in orizzontale per avere più spazio.',victoryText:'Macina è sconfitto! Il Sigillo di Nardò è salvato in questo browser.'},
es:{intro:'Supera los muros de piedra para alcanzar los diez lugares de los caminos de Nardò. Sigue la pista de la tarántula y guía a Aracne al marcador correcto.',wall:'Muros de piedra',coffee:'Caffè leccese · energía +30',rustico:'Rustico · escudo 8 s',pasticciotto:'Pasticciotto · energía +20 · vuelo lento 7 s',hit:'¡Cuidado con los enemigos!',energy:'Energía',battle:'Batalla de Nardò',battleIntro:'Has encontrado los diez lugares. Enfréntate a Macina con las provisiones recogidas.',battleHelp:'← → mover · ↑ aletear · ↓ picado · ↯ esquivar · A atacar · B especial.',fight:'Combatir',jump:'Aleteo',attack:'Ataque',special:'Especial',warning:'¡Atención: Macina carga!',exposed:'¡Ahora! Macina es vulnerable.',phase:'¡Macina acelera!',lost:'Aracne recupera el aliento',retry:'Reintentar batalla',lostText:'Conservas tus descubrimientos y provisiones para reintentar.',victory:'¡Los caminos de Nardò son libres!',boss:'Macina',safe:'Escudo activo',focus:'Vuelo lento',normal:'Vuelo tranquilo',orientation:'Batalla: gira a horizontal para tener más espacio.',victoryText:'¡Macina derrotado! El Sello de Nardò se guarda en este navegador.'}
};
function extra(){return extras[lang]}
function extraLabels(){ui[lang].intro=extra().intro;ui[lang].win=extra().victory;ui[lang].won=extra().victoryText;$('jump').textContent='↑';$('jump').setAttribute('aria-label',battleUI().flap);$('dive').setAttribute('aria-label',battleUI().dive);$('dodge').textContent='↯ '+battleUI().dodge;$('attack').textContent='A · '+extra().attack;$('special').textContent='B · '+extra().special;$('energyLabel').textContent=extra().energy;$('bonusHelp').textContent=extra().coffee+' · '+extra().rustico+' · '+extra().pasticciotto;for(const kind of ['coffee','rustico','pasticciotto'])$(kind+'Count').parentElement?.setAttribute('title',extra()[kind]);$('targetsList').textContent=state.targets.map(t=>t.number+' · '+place(t.id).name).join('   /   ');if(state.mode==='battle'||(state.mode==='paused'&&state.previous==='battle')){Battle.hud();$('speaker').textContent=extra().battle;$('question').textContent=extra().battleHelp;$('targetsList').textContent='Aracne ✦ Macina';$('tip').textContent=extra().orientation;}}
...
function sendHost(type,data={}){if(window.parent!==window)window.parent.postMessage({source:'hirundu-level7',type,...data},location.origin)}
...
if(document.modelContext?.registerTool){const lifecycle=new AbortController();try{Promise.resolve(document.modelContext.registerTool({name:'read_level7_progress',description:'Read progress in the Aracne rebound level 7.',inputSchema:{type:'object',properties:{},additionalProperties:false},annotations:{readOnlyHint:true},execute:()=>({mode:state.mode,discoveries:state.found.length,score:state.score,question:state.round<10?place(active()).info:null,inventory:{...state.food},battle:state.mode==='battle'?{playerHP:Battle.data.player.hp,bossHP:Battle.data.boss.hp}:null})},{signal:lifecycle.signal})).catch(()=>{})}catch{}addEventListener('pagehide',()=>lifecycle.abort(),{once:true})}
