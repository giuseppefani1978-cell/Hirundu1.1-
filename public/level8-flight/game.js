...
function launchBattle(){
  ...
  const sameApp=location.hostname==='giuseppefani1978-cell.github.io';
  if(sameApp) location.href=location.origin+rootPath+'#/level/8?test=battle';
  else location.href='https://giuseppefani1978-cell.github.io/Hirundu1.1-/#/level/8?test=battle';
}
