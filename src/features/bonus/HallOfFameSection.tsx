...
const SOURCE_META: SourceMeta[] = [
  ...
  { key: "salento_hof_v5", label: `${copy.level} 5`, suffix: "💧", alwaysShow: true },
  { key: "salento_hof_v4", label: `${copy.level} 4`, suffix: "🐚", alwaysShow: true },
  { key: "salento_hof_v6", label: `${copy.level} 6`, suffix: "🌲", alwaysShow: true },
  { key: "salento_hof_v7", label: `${copy.level} 7`, suffix: "🫒", alwaysShow: true },
  { key: "salento_hof_v8", label: `${copy.level} 8`, suffix: "🏺", alwaysShow: true },
  { key: "salento_hof_v9", label: `${copy.level} 9`, suffix: "💎", alwaysShow: true },
