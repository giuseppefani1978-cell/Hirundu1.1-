...
const messages = {
  fr: {
    ...
    pause: "Pause", resume: "Reprendre", restart: "Rejouer le niveau", discoveries: "Mes découvertes",
    performance: "Performance", jank: "saccades",
    pause: "Pause", resume: "Reprendre", restartLevel: "Recommencer le niveau",
    ...
    continue: 'Continuer la chasse', replay: 'Rejouer', complete: 'Les neuf chasses sont terminées !',
  ...
  it: {
    ...
    pause: "Pausa", resume: "Riprendi", restart: "Rigioca il livello", discoveries: "Le mie scoperte",
    performance: "Prestazioni", jank: "scatti",
    pause: "Pausa", resume: "Riprendi", restartLevel: "Ricomincia il livello",
    ...
    continue: 'Continua la caccia', replay: 'Gioca di nuovo', complete: 'Hai completato tutte e nove le cacce!',
  ...
  en: {
    ...
    pause: "Pause", resume: "Resume", restart: "Restart level", discoveries: "My discoveries",
    performance: "Performance", jank: "jank",
    pause: "Pause", resume: "Resume", restartLevel: "Restart level",
    ...
    continue: 'Continue the hunt', replay: 'Play again', complete: 'All nine hunts completed!',
  ...
  es: {
    ...
    pause: "Pausa", resume: "Continuar", restart: "Reiniciar nivel", discoveries: "Mis descubrimientos",
    performance: "Rendimiento", jank: "tirones",
    pause: "Pausa", resume: "Continuar", restartLevel: "Reiniciar nivel",
    ...
    continue: 'Continuar la búsqueda', replay: 'Volver a jugar', complete: '¡Has completado las nueve búsquedas!',
